...
namespace CoreCms.Net.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class CoreCmsUserSignServices : BaseServices<CoreCmsUserSign>, ICoreCmsUserSignServices
    {
        private readonly ICoreCmsUserSignRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public CoreCmsUserSignServices(IUnitOfWork unitOfWork, ICoreCmsUserSignRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
