...
namespace CoreCms.Net.Services
{
    ...
    /// 快递信息表 接口实现
    /// </summary>
    public class CoreCmsParcelStorageServices : BaseServices<CoreCmsParcelStorage>, ICoreCmsParcelStorageServices
    {
        private readonly ICoreCmsParcelStorageRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public CoreCmsParcelStorageServices(IUnitOfWork unitOfWork, ICoreCmsParcelStorageRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
