...
namespace CoreCms.Net.Services
{
    ...
    /// 快递配送表 接口实现
    /// </summary>
    public class CoreCmsExpressOrderServices : BaseServices<CoreCmsExpressOrder>, ICoreCmsExpressOrderServices
    {
        private readonly ICoreCmsExpressOrderRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public CoreCmsExpressOrderServices(IUnitOfWork unitOfWork, ICoreCmsExpressOrderRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
